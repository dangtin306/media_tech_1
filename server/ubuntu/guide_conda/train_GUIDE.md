# Qwen3.5-4B LoRA Training Guide

This folder contains the LoRA training scripts for `Qwen/Qwen3.5-4B`.
...
- `D:\huggingface\hub\Qwen\Qwen3.5-4B_vn_1\adapter`
- `D:\huggingface\hub\Qwen\Qwen3.5-4B_vn_1\merged`
- `/root/model/Qwen/Qwen3.5-4B_vn_1/adapter`
- `/root/model/Qwen/Qwen3.5-4B_vn_1/merged`
